...
export const About: FC<AboutSectionProps> = ({ className = "" }) => {
  return (
    <section id="about" className={`py-24 lg:py-32 ${className}`}>
      <motion.div
      ...
      >
        ...
        <div className="space-y-4 text-gray-600 dark:text-gray-400">
          <p>
            Hello! I&apos;m Ural, a passionate frontend developer with a keen
            eye for creating engaging digital experiences. My journey in web
            development began in 2018, and since then, I&apos;ve had the
            privilege of working with diverse teams and technologies.
          </p>
